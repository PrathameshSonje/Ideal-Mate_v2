            ...
            {collapsed ? (
                <div className="w-[60px] px-2 flex flex-col h-full pb-2">
                    <div className="flex-1">
                        ...
                        <div className="flex flex-col gap-2">
                            {
                                files.map((file) => (
                                    <div className="h-[44px] w-[44px] border-2 rounded-sm flex items-center justify-center font-medium text-zinc-700 text-sm cursor-pointer hover:bg-zinc-200">
                                        {file}
                                    </div>
                                ))
                            }
                ...
                <div className="w-[240px] px-4">
                    <div className="flex items-center justify-between h-[50px]">
                        <span className="font-bold text-zinc-800">Ideal-Mate</span>
