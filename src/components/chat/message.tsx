        ...
        <>
            {
                isUserMessage ? (
                    <div className="flex flex-col items-end gap-2">
                        ...
                        <div className="bg-[#3C3C3C] text-slate-50 px-3 py-2 rounded-md text-sm">
                            This a question asked by a user
                        </div>
                    </div>
                ) : (
                    <div className="flex flex-col items-start gap-1">
                        <div className="flex gap-1.5 text-sm items-center text-zinc-500 h-4">
